...
public class MainActivity extends AppCompatActivity {
    ...
    private void AnimateImage(){
        ImageView player_choice = findViewById(R.id.Player_Move_Image);
        ImageView game_choice = findViewById(R.id.AI_Move_Image);
    ...
    private void GameMove(Roshambo game, TextView result){
        ImageView game_choice = findViewById(R.id.AI_Move_Image);
    ...
    private void PlayerMove(String image_name, Roshambo game, TextView result){
        ImageView player_choice = findViewById(R.id.Player_Move_Image);
